 ...
 * Date: Wed Dec 09 2020 00:18:26 GMT+0200 (EET)
 *
...
Ext.define('Bank.controller.CrKassa', {
        ...
        stTekNachKassa.load({
            ...
            callback: function(records,operation,success){
                ...
                if (success)  {
                    ...
                    fmTekNachKassa.down('#NextAllReset').setDisabled(false);
                    fmTekNachKassa.down('#NextAll').setDisabled(false);
                    //fmTekNachKassa.getForm().findField('newOplata').focus();
    ...
    InsTekPokVodomera: function() {
        // in use
        var me = this;
        //var btn = Ext.getCmp('insTekPokVodKassa');
